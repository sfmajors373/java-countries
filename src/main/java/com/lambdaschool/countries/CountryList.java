...
public class CountryList
{
    ...
    public ArrayList<Country> startsWithLetter(String letters)
    {
        ArrayList<Country> letterCountries = new ArrayList<Country>();
        for (Country c : countryList)
        {
            if (c.getName().startsWith(letters))
            {
                letterCountries.add(c);
            }
        }
